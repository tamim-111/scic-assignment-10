...
const BusinessElite = () => {
    ...
    const faqs = [
        {
            question: "Can I hire a professional chauffeur?",
            answer:
                "Yes, the Business Elite package offers an optional professional chauffeur for your convenience and safety.",
        },
        {
            question: "What kind of refreshments are provided?",
            answer:
                "Complimentary refreshments include bottled water, coffee, and soft drinks during your ride.",
        },
        {
            question: "Is priority support available 24/7?",
            answer:
                "Absolutely! Priority customer support is available around the clock to assist with any inquiries or issues.",
        },
    ];
        ...
        <div className="mt-40 dark:bg-gray-900 min-h-screen py-12 px-6">
            <div className="max-w-6xl mx-auto bg-white dark:bg-gray-800 rounded-lg shadow-lg p-8">
                ...
                <p className="text-lg text-gray-700 dark:text-gray-300 text-center mb-4 max-w-3xl mx-auto">
                    Premium cars designed for executives who value unmatched comfort,
                    prestige, and professionalism. Experience luxury interiors,
                    advanced technology, and top-tier service tailored to your business
                    needs.
                </p>
                ...
                <div className="flex justify-center mb-8">
                    ...
                    <span className="ml-2 text-gray-600 dark:text-gray-400">(256 reviews)</span>
                </div>

                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                    <div>
                        <img
                            src="https://shorturl.at/6UxFb"
                            alt="Business Elite"
